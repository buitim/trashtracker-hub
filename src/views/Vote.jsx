...
import { Typography, Image, Button, Skeleton, BackTop } from 'antd';
        ...
        if (this.state.isLoading) {
            ...
            return (
                <div className='vote-view-container'>
                    ...
                    <Button id='left-button' className='vote-view-btn' type='primary' onClick={this.onVoteButtonClick}>Vote</Button>
                    <Button id='right-button' className='vote-view-btn' type='primary' onClick={this.onVoteButtonClick}>Vote</Button>
