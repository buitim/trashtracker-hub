        ...
        if (this.state.isLoading) {
            ...
            return (
                <div className='vote-view-container'>
                    ...
                    <Button id='left-button' className='vote-view-btn' type='primary'>Vote</Button>
                    <Button id='right-button' className='vote-view-btn' type='primary'>Vote</Button>
